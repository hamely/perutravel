          ...
          <div class="col-md-8 mb-md-140">
            ...
            <div class="blog-item alt pb-20">
              ...
              <div class="blog-item-data clearfix">
                <h3 class="blog-title">In tempus felis vitae ornare commodo</h3>
                <p class="post-info"><i class="flaticon-people"></i><span class="posr-author">Phillip Ferguson </span>on<a href="#" class="post-category"> <span>Adventure</span></a>,<a href="#" class="post-category"> <span>Wildlife </span></a>at Mon, 03-23-2016</p>
              </div>
              <!-- Text Intro-->
              <p class="mb-25">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. In ac orci eu felis venenatis tincidunt. Phasellus et hendrerit nisi. Phasellus eleifend velit sed gravida elementum. Mauris elementum varius turpis, a dictum justo bibendum nec. Integer sollicitudin ipsum vitae orci fringilla, sit amet ultrices elit volutpat. Duis sed nulla laoreet, suscipit urna id, pretium leo. Maecenas ligula elit, tempus at erat nec, convallis iaculis neque. Nunc at viverra erat.</p>
              <p>Donec tristique blandit urna, cursus eleifend urna. Aliquam ut enim sapien. Nulla dapibus facilisis arcu, eget auctor est venenatis vel. <ins class="alt-4">Nulla rhoncus</ins>, quam sed finibus ornare, tellus justo hendrerit dolor, eget commodo elit massa in nibh. Vestibulum et ligula nisl. Vivamus ornare suscipit ante, et convallis felis ultrices in. Nulla vehicula mollis nulla a ultrices. Donec at diam mattis quam ultricies pharetra. Suspendisse eu nisl nec sem eleifend pellentesque nec in orci. Suspendisse quis sem in purus blandit gravida. Vestibulum congue fermentum orci id mollis. Morbi accumsan ante id tortor ullamcorper, sit amet volutpat arcu consectetur.</p>
              <!-- Blockquote-->
              ...
              <!-- Text Intro-->
              <p class="mb-30">Suspendisse imperdiet quis ipsum et aliquam. Nulla lacinia turpis et felis tempus, in tincidunt dui dapibus. Nam sit amet ipsum quam. Nunc maximus id ex vitae facilisis. Nulla lobortis volutpat bibendum. In in ligula nibh. Sed quis turpis at turpis aliquam pretium in sed risus. Nam augue lacus, blandit vel lorem vel, tempus scelerisque massa.</p>
              <!-- Post Tags-->
