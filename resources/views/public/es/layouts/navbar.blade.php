    ...
    <header>
          ...
          <div class="row">
            <div class="col-md-6 col-sm-7">
              ...
              <div class="top-left-wrap font-3">
                <div class="mail-top"><a href="mailto:reservas@machupicchugolden.com"> <i class="flaticon-suntour-email"></i>reservas@machupicchugolden.com</a></div><span>/</span>
      ...
      <nav class="main-nav js-stick">
        <div class="full-wrapper relative clearfix container">
          ...
          <div class="nav-logo-wrap local-scroll"><a href="index.html" class="logo"><img src="/public/img/logo.png" data-at2x="img/logo@2x.png" alt></a></div>
          <!-- Main Menu-->
          <div class="inner-nav desktop-nav">
            <ul class="clearlist">
              <!-- Item With Sub-->
              <li>
                <a href="index.html" class="mn-has-sub active">INICIO</a>
              </li>
              <!-- End Item With Sub-->
              <li class="slash">/</li>
              <!-- Item With Sub-->
              <li><a href="hotels-search.html" class="mn-has-sub">PAQUETES<i class="fa fa-angle-down button_open"></i></a>
                <!-- Sub-->
                <ul class="mn-sub">
                  <li><a href="hotels-list.html">AVENTURA</a></li>
